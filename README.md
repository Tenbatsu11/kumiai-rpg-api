...
The api is mean to be used with the desktop Kumiai Go Learn app.
To check the use cases and fonctionnality of the desktop app, please refer to the according repository.

----- Before starting the api -----

Before anything else, you should create the "application.properties" file under the forlder resources. 
